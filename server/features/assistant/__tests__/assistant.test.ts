...
import { assistantRouter } from '../assistant.router.ts';
...
vi.mock('../../system/system.service.ts', () => {
  return {
    SystemService: class {
...
vi.mock('../../local-models/localModels.service.ts', () => {
  return {
...
vi.mock('../../cache/cache.service.ts', () => {
  return {
    CacheService: class {
...
vi.mock('../../workspace/workspace.service.ts', () => {
  return {
