...
import { INluAdapter, NluParseResult } from './adapters/nlu.interface.ts';
import { LocalAdapter } from './adapters/local.adapter.ts';
import { DialogflowAdapter } from './adapters/dialogflow.adapter.ts';
import { RasaAdapter } from './adapters/rasa.adapter.ts';
import { BotFrameworkAdapter } from './adapters/botframework.adapter.ts';

import { SystemService } from '../system/system.service.ts';
import { LocalModelsService } from '../local-models/localModels.service.ts';
...
export class AssistantService {
  ...
  async getConfig(): Promise<{
    ...
    const dialogflowProject = process.env.DIALOGFLOW_PROJECT_ID;
    const dialogflowToken = process.env.DIALOGFLOW_ACCESS_TOKEN;
