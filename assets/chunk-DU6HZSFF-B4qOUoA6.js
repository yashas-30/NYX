...
import { d as e, t, u as n, __tla as __tla_0 } from "./index-DGNEn3r-.js";
import { n as r, t as i } from "./chunk-Y2CYZVJY-DsF7k-Jl.js";
import { n as a, t as o } from "./chunk-X3CZISLH-BnlqbmGY.js";
let S, K, Vt, $e, le, Fe, yt, zt, Mt, ze, wt, Pt, je, pt, Wt, ut, Ze, Pe, M, Gt, Ge, At, Ne, Ie, Ot, Ht, A, Ke, kt, c, B, Ct, Bt, x, Oe, P, qe, _t, _, H, We, Tt, V, Re, y, J, Xe, Me, E, v, bt, Ye, b, N, Nt, Ft, Rt, jt, U;
let __tla = Promise.all([
    ...
    s = {
        ...
        hsl2rgb: ({ h: e, s: t, l: n }, r)=>{
            ...
            switch(r){
                case `r`:
                    return s.hue2rgb(a, i, e + 1 / 3) * 255;
                case `g`:
                    return s.hue2rgb(a, i, e) * 255;
                case `b`:
                    return s.hue2rgb(a, i, e - 1 / 3) * 255;
            }
        },
    ...
    l = {};
    for(let e = 0; e <= 255; e++)l[e] = c.unit.dec2hex(e);
    let u, d, f, p, m, h, g, ee, te, ne, C, re, w;
    u = {
        ALL: 0,
        RGB: 1,
        HSL: 2
    ...
    f = new class {
        constructor(e, t){
            this.color = t, this.changed = !1, this.data = e, this.type = new d;
        }
        set(e, t) {
            return this.color = t, this.changed = !1, this.data = e, this.type.type = u.ALL, this;
        }
        _ensureHSL() {
            let e = this.data, { h: t, s: n, l: r } = e;
            t === void 0 && (e.h = c.channel.rgb2hsl(e, `h`)), n === void 0 && (e.s = c.channel.rgb2hsl(e, `s`)), r === void 0 && (e.l = c.channel.rgb2hsl(e, `l`));
        }
        _ensureRGB() {
            let e = this.data, { r: t, g: n, b: r } = e;
            t === void 0 && (e.r = c.channel.hsl2rgb(e, `r`)), n === void 0 && (e.g = c.channel.hsl2rgb(e, `g`)), r === void 0 && (e.b = c.channel.hsl2rgb(e, `b`));
        }
        get r() {
            let e = this.data, t = e.r;
            return !this.type.is(u.HSL) && t !== void 0 ? t : (this._ensureHSL(), c.channel.hsl2rgb(e, `r`));
        }
        get g() {
            let e = this.data, t = e.g;
            return !this.type.is(u.HSL) && t !== void 0 ? t : (this._ensureHSL(), c.channel.hsl2rgb(e, `g`));
        }
        get b() {
            let e = this.data, t = e.b;
            return !this.type.is(u.HSL) && t !== void 0 ? t : (this._ensureHSL(), c.channel.hsl2rgb(e, `b`));
        }
        get h() {
            let e = this.data, t = e.h;
            return !this.type.is(u.RGB) && t !== void 0 ? t : (this._ensureRGB(), c.channel.rgb2hsl(e, `h`));
        }
        get s() {
            let e = this.data, t = e.s;
            return !this.type.is(u.RGB) && t !== void 0 ? t : (this._ensureRGB(), c.channel.rgb2hsl(e, `s`));
        }
        get l() {
            let e = this.data, t = e.l;
            return !this.type.is(u.RGB) && t !== void 0 ? t : (this._ensureRGB(), c.channel.rgb2hsl(e, `l`));
        }
        get a() {
            return this.data.a;
        }
    ...
    p = {
        ...
        stringify: (e)=>{
            ...
            return i < 1 ? `#${l[Math.round(t)]}${l[Math.round(n)]}${l[Math.round(r)]}${l[Math.round(i * 255)]}` : `#${l[Math.round(t)]}${l[Math.round(n)]}${l[Math.round(r)]}`;
        }
    };
    m = {
        ...
        _hue2deg: (e)=>{
            let t = e.match(m.hueRe);
            if (t) {
                let [, e, n] = t;
                switch(n){
                    case `grad`:
                        return c.channel.clamp.h(parseFloat(e) * .9);
                    case `rad`:
                        return c.channel.clamp.h(parseFloat(e) * 180 / Math.PI);
                    case `turn`:
                        return c.channel.clamp.h(parseFloat(e) * 360);
                }
            }
            return c.channel.clamp.h(parseFloat(e));
        },
        parse: (e)=>{
            ...
            return f.set({
                h: m._hue2deg(r),
                s: c.channel.clamp.s(parseFloat(i)),
                l: c.channel.clamp.l(parseFloat(a)),
                a: o ? c.channel.clamp.a(s ? parseFloat(o) / 100 : parseFloat(o)) : 1
            }, e);
        },
        stringify: (e)=>{
            let { h: t, s: n, l: r, a: i } = e;
            return i < 1 ? `hsla(${c.lang.round(t)}, ${c.lang.round(n)}%, ${c.lang.round(r)}%, ${i})` : `hsl(${c.lang.round(t)}, ${c.lang.round(n)}%, ${c.lang.round(r)}%)`;
        }
    };
    h = {
        colors: {
        ...
        parse: (e)=>{
            e = e.toLowerCase();
            let t = h.colors[e];
            if (t) return p.parse(t);
        },
        stringify: (e)=>{
            let t = p.stringify(e);
            for(let e in h.colors)if (h.colors[e] === t) return e;
        }
    };
    g = {
        ...
        parse: (e)=>{
            ...
            let n = e.match(g.re);
            if (!n) return;
            let [, r, i, a, o, s, l, u, d] = n;
            return f.set({
                r: c.channel.clamp.r(i ? parseFloat(r) * 2.55 : parseFloat(r)),
                g: c.channel.clamp.g(o ? parseFloat(a) * 2.55 : parseFloat(a)),
                b: c.channel.clamp.b(l ? parseFloat(s) * 2.55 : parseFloat(s)),
                a: u ? c.channel.clamp.a(d ? parseFloat(u) / 100 : parseFloat(u)) : 1
            }, e);
        },
        stringify: (e)=>{
            let { r: t, g: n, b: r, a: i } = e;
            return i < 1 ? `rgba(${c.lang.round(t)}, ${c.lang.round(n)}, ${c.lang.round(r)}, ${c.lang.round(i)})` : `rgb(${c.lang.round(t)}, ${c.lang.round(n)}, ${c.lang.round(r)})`;
        }
    };
    _ = {
        format: {
        ...
        parse: (e)=>{
            ...
            let t = p.parse(e) || g.parse(e) || m.parse(e) || h.parse(e);
            if (t) return t;
            throw Error(`Unsupported color format: "${e}"`);
        },
        stringify: (e)=>!e.changed && e.color ? e.color : e.type.is(u.HSL) || e.data.r === void 0 ? m.stringify(e) : e.a < 1 || !Number.isInteger(e.r) || !Number.isInteger(e.g) || !Number.isInteger(e.b) ? g.stringify(e) : p.stringify(e)
    };
    ee = (e, t)=>{
        let n = _.parse(e);
        for(let e in t)n[e] = c.channel.clamp[e](t[e]);
        return _.stringify(n);
    };
    v = (e, t, n = 0, r = 1)=>{
        if (typeof e != `number`) return ee(e, {
            a: t
        });
        let i = f.set({
            r: c.channel.clamp.r(e),
            g: c.channel.clamp.g(t),
            b: c.channel.clamp.b(n),
            a: c.channel.clamp.a(r)
        });
        return _.stringify(i);
    };
    te = (e)=>{
        let { r: t, g: n, b: r } = _.parse(e), i = .2126 * c.channel.toLinear(t) + .7152 * c.channel.toLinear(n) + .0722 * c.channel.toLinear(r);
        return c.lang.round(i);
    };
    ne = (e)=>te(e) >= .5;
    y = (e)=>!ne(e);
    b = (e, t, n)=>{
        let r = _.parse(e), i = r[t], a = c.channel.clamp[t](i + n);
        return i !== a && (r[t] = a), _.stringify(r);
    };
    x = (e, t)=>b(e, `l`, t);
    S = (e, t)=>b(e, `l`, -t);
    C = (e, t)=>{
    ...
    re = (e, t, n = 50)=>{
        let { r, g: i, b: a, a: o } = _.parse(e), { r: s, g: c, b: l, a: u } = _.parse(t), d = n / 100, f = d * 2 - 1, p = o - u, m = ((f * p === -1 ? f : (f + p) / (1 + f * p)) + 1) / 2, h = 1 - m;
        return v(r * m + s * h, i * m + c * h, a * m + l * h, o * d + u * (1 - d));
    };
    w = (e, t = 100)=>{
        let n = _.parse(e);
        return n.r = 255 - n.r, n.g = 255 - n.g, n.b = 255 - n.b, re(n, e, t);
    };
    e();
    let T, D, O, k, ie, ae, oe, se, ce, ue, de, fe, pe, me, he, ge, _e, ve, ye, be, xe, Se, Ce, we, j, Te, Ee, De, ke, Ae, F, I, L, R, z, Le, Be, Ve, He, Ue, Je, Qe, et, tt;
    T = r((e, t, { depth: n = 2 } = {})=>{
        let r = {
            depth: n
        };
        if (Array.isArray(t) && !Array.isArray(e)) return t.forEach((t)=>T(e, t, r)), e;
            ...
            Object.entries(t).forEach(([t, i])=>{
                if (typeof i == `object`) {
                    ...
                    Object.hasOwn(e, t) || Object.defineProperty(e, t, {
                        ...
                        enumerable: !0,
                        configurable: !0
                    }), r[t] === void 0 && (r[t] = Array.isArray(i) ? [] : {}), typeof r[t] == `object` && (r[t] = T(r[t], i, {
                        depth: n - 1
                    }));
    ...
    ie = class {
        ...
        updateColors() {
            ...
            this.classText = this.classText || this.textColor, this.fillType0 = this.fillType0 || this.primaryColor, this.fillType1 = this.fillType1 || this.secondaryColor, this.fillType2 = this.fillType2 || C(this.primaryColor, {
                h: 64
            }), this.fillType3 = this.fillType3 || C(this.secondaryColor, {
                h: 64
            }), this.fillType4 = this.fillType4 || C(this.primaryColor, {
                h: -64
            }), this.fillType5 = this.fillType5 || C(this.secondaryColor, {
                h: -64
            }), this.fillType6 = this.fillType6 || C(this.primaryColor, {
                h: 128
            }), this.fillType7 = this.fillType7 || C(this.secondaryColor, {
                h: 128
            }), this.pie1 = this.pie1 || this.primaryColor, this.pie2 = this.pie2 || this.secondaryColor, this.pie3 = this.pie3 || this.tertiaryColor, this.pie4 = this.pie4 || C(this.primaryColor, {
                l: -10
            }), this.pie5 = this.pie5 || C(this.secondaryColor, {
                l: -10
                ...
                g: -15,
                b: -15
            }), this.quadrantPointFill = this.quadrantPointFill || y(this.quadrant1Fill) ? x(this.quadrant1Fill) : S(this.quadrant1Fill), this.quadrantPointTextFill = this.quadrantPointTextFill || this.primaryTextColor, this.quadrantXAxisTextFill = this.quadrantXAxisTextFill || this.primaryTextColor, this.quadrantYAxisTextFill = this.quadrantYAxisTextFill || this.primaryTextColor, this.quadrantInternalBorderStrokeFill = this.quadrantInternalBorderStrokeFill || this.primaryBorderColor, this.quadrantExternalBorderStrokeFill = this.quadrantExternalBorderStrokeFill || this.primaryBorderColor, this.quadrantTitleFill = this.quadrantTitleFill || this.primaryTextColor, this.xyChart = {
    ...
    oe = class {
        ...
        updateColors() {
            ...
            for(let e = 0; e < this.THEME_COLOR_LIMIT; e++)this[`cScaleInv` + e] = this[`cScaleInv` + e] || w(this[`cScale` + e]);
            for(let e = 0; e < this.THEME_COLOR_LIMIT; e++)this[`cScalePeer` + e] = this[`cScalePeer` + e] || x(this[`cScale` + e], 10);
            ...
            for(let e = 0; e < 8; e++)this[`venn` + (e + 1)] = this[`venn` + (e + 1)] ?? x(this[`cScale` + e], 30);
            this.vennTitleTextColor = this.vennTitleTextColor ?? this.titleColor, this.vennSetTextColor = this.vennSetTextColor ?? this.textColor, this.cynefin = {
                domainFontSize: this.cynefin?.domainFontSize || 16,
                itemFontSize: this.cynefin?.itemFontSize || 12,
                boundaryColor: this.cynefin?.boundaryColor || this.lineColor,
                ...
                textColor: this.cynefin?.textColor || this.textColor,
                labelColor: this.cynefin?.labelColor || this.primaryTextColor
            }, this.quadrant1Fill = this.quadrant1Fill || this.primaryColor, this.quadrant2Fill = this.quadrant2Fill || C(this.primaryColor, {
                r: 5,
                g: 5,
                b: 5
            }), this.quadrant3Fill = this.quadrant3Fill || C(this.primaryColor, {
    ...
    ce = class {
        ...
        updateColors() {
            this.cScale0 = this.cScale0 || this.primaryColor, this.cScale1 = this.cScale1 || this.secondaryColor, this.cScale2 = this.cScale2 || this.tertiaryColor, this.cScale3 = this.cScale3 || C(this.primaryColor, {
                ...
                h: 330
            }), this.cScalePeer1 = this.cScalePeer1 || S(this.secondaryColor, 45), this.cScalePeer2 = this.cScalePeer2 || S(this.tertiaryColor, 40);
            ...
            this.nodeBkg = this.mainBkg, this.nodeBorder = this.border1, this.clusterBkg = this.secondBkg, this.clusterBorder = this.border2, this.defaultLinkColor = this.lineColor, this.titleColor = this.textColor, this.edgeLabelBackground = this.labelBackground, this.actorBorder = this.border1, this.actorBkg = this.mainBkg, this.labelBoxBkgColor = this.actorBkg, this.signalColor = this.textColor, this.signalTextColor = this.textColor, this.labelBoxBorderColor = this.actorBorder, this.labelTextColor = this.actorTextColor, this.loopTextColor = this.actorTextColor, this.noteBorderColor = this.border2, this.noteTextColor = this.actorTextColor, this.actorLineColor = this.actorBorder, this.rectBkgColor = this.rectBkgColor || this.tertiaryColor, this.taskTextColor = this.taskTextLightColor, this.taskTextOutsideColor = this.taskTextDarkColor, this.archEdgeColor = this.lineColor, this.archEdgeArrowColor = this.lineColor, this.rowOdd = this.rowOdd || x(this.primaryColor, 75) || `#ffffff`, this.rowEven = this.rowEven || x(this.primaryColor, 1), this.transitionColor = this.transitionColor || this.lineColor, this.transitionLabelColor = this.transitionLabelColor || this.textColor, this.stateLabelColor = this.stateLabelColor || this.stateBkg || this.primaryTextColor, this.stateBkg = this.stateBkg || this.mainBkg, this.labelBackgroundColor = this.labelBackgroundColor || this.stateBkg, this.compositeBackground = this.compositeBackground || this.background || this.tertiaryColor, this.altBackground = this.altBackground || `#f0f0f0`, this.compositeTitleBackground = this.compositeTitleBackground || this.mainBkg, this.compositeBorder = this.compositeBorder || this.nodeBorder, this.innerEndBackground = this.nodeBorder, this.specialStateColor = this.lineColor, this.errorBkgColor = this.errorBkgColor || this.tertiaryColor, this.errorTextColor = this.errorTextColor || this.tertiaryTextColor, this.transitionColor = this.transitionColor || this.lineColor, this.classText = this.primaryTextColor, this.fillType0 = this.primaryColor, this.fillType1 = this.secondaryColor, this.fillType2 = C(this.primaryColor, {
                ...
                h: 128
            }), this.pie1 = this.pie1 || this.primaryColor, this.pie2 = this.pie2 || this.secondaryColor, this.pie3 = this.pie3 || C(this.tertiaryColor, {
                l: -40
            }), this.pie4 = this.pie4 || C(this.primaryColor, {
                l: -10
            }), this.pie5 = this.pie5 || C(this.secondaryColor, {
                l: -30
            }), this.pie6 = this.pie6 || C(this.tertiaryColor, {
                ...
                h: 120
            }), this.darkMode ? (this.git0 = x(this.git0, 25), this.git1 = x(this.git1, 25), this.git2 = x(this.git2, 25), this.git3 = x(this.git3, 25), this.git4 = x(this.git4, 25), this.git5 = x(this.git5, 25), this.git6 = x(this.git6, 25), this.git7 = x(this.git7, 25)) : (this.git0 = S(this.git0, 25), this.git1 = S(this.git1, 25), this.git2 = S(this.git2, 25), this.git3 = S(this.git3, 25), this.git4 = S(this.git4, 25), this.git5 = S(this.git5, 25), this.git6 = S(this.git6, 25), this.git7 = S(this.git7, 25)), this.gitInv0 = this.gitInv0 || S(w(this.git0), 25), this.gitInv1 = this.gitInv1 || w(this.git1), this.gitInv2 = this.gitInv2 || w(this.git2), this.gitInv3 = this.gitInv3 || w(this.git3), this.gitInv4 = this.gitInv4 || w(this.git4), this.gitInv5 = this.gitInv5 || w(this.git5), this.gitInv6 = this.gitInv6 || w(this.git6), this.gitInv7 = this.gitInv7 || w(this.git7), this.gitBranchLabel0 = this.gitBranchLabel0 || w(this.labelTextColor), this.gitBranchLabel1 = this.gitBranchLabel1 || this.labelTextColor, this.gitBranchLabel2 = this.gitBranchLabel2 || this.labelTextColor, this.gitBranchLabel3 = this.gitBranchLabel3 || w(this.labelTextColor), this.gitBranchLabel4 = this.gitBranchLabel4 || this.labelTextColor, this.gitBranchLabel5 = this.gitBranchLabel5 || this.labelTextColor, this.gitBranchLabel6 = this.gitBranchLabel6 || this.labelTextColor, this.gitBranchLabel7 = this.gitBranchLabel7 || this.labelTextColor, this.tagLabelColor = this.tagLabelColor || this.primaryTextColor, this.tagLabelBackground = this.tagLabelBackground || this.primaryColor, this.tagLabelBorder = this.tagBorder || this.primaryBorderColor, this.tagLabelFontSize = this.tagLabelFontSize || `10px`, this.commitLabelColor = this.commitLabelColor || this.secondaryTextColor, this.commitLabelBackground = this.commitLabelBackground || this.secondaryColor, this.commitLabelFontSize = this.commitLabelFontSize || `10px`, this.emUiFill = this.emUiFill || `white`, this.emUiStroke = this.emUiStroke || `#dbdada`, this.emProcessorFill = this.emProcessorFill || `#edb3f6`, this.emProcessorStroke = this.emProcessorStroke || `#b88cbf`, this.emReadModelFill = this.emReadModelFill || `#d3f1a2`, this.emReadModelStroke = this.emReadModelStroke || `#a3b732`, this.emCommandFill = this.emCommandFill || `#bcd6fe`, this.emCommandStroke = this.emCommandStroke || `#679ac3`, this.emEventFill = this.emEventFill || `#ffb778`, this.emEventStroke = this.emEventStroke || `#c19a0f`, this.emSwimlaneBackgroundOdd = this.emSwimlaneBackgroundOdd || `rgb(250,250,250)`, this.emSwimlaneBackgroundStroke = this.emSwimlaneBackgroundStroke || `rgb(240,240,240)`, this.emArrowhead = this.emArrowhead || this.lineColor, this.emRelationStroke = this.emRelationStroke || this.lineColor, this.attributeBackgroundColorOdd = this.attributeBackgroundColorOdd || D, this.attributeBackgroundColorEven = this.attributeBackgroundColorEven || O;
        }
        calculate(e) {
    ...
    fe = class {
        ...
        constructor(){
            this.primaryColor = `#eee`, this.contrast = `#707070`, this.secondaryColor = x(this.contrast, 55), this.background = `#ffffff`, this.tertiaryColor = C(this.primaryColor, {
                h: -160
        ...
        updateColors() {
            ...
            this.vennTitleTextColor = this.vennTitleTextColor ?? this.titleColor, this.vennSetTextColor = this.vennSetTextColor ?? this.textColor, this.cynefin = {
                ...
                annotationTextColor: this.wardley?.annotationTextColor || this.primaryTextColor,
                annotationFill: this.wardley?.annotationFill || this.background
            }, this.requirementBackground = this.requirementBackground || this.primaryColor, this.requirementBorderColor = this.requirementBorderColor || this.primaryBorderColor, this.requirementBorderSize = this.requirementBorderSize || `1`, this.requirementTextColor = this.requirementTextColor || this.primaryTextColor, this.relationColor = this.relationColor || this.lineColor, this.relationLabelBackground = this.relationLabelBackground || this.edgeLabelBackground, this.relationLabelColor = this.relationLabelColor || this.actorTextColor, this.git0 = S(this.pie1, 25) || this.primaryColor, this.git1 = this.pie2 || this.secondaryColor, this.git2 = this.pie3 || this.tertiaryColor, this.git3 = this.pie4 || C(this.primaryColor, {
                h: -30
            }), this.git4 = this.pie5 || C(this.primaryColor, {
                h: -60
            }), this.git5 = this.pie6 || C(this.primaryColor, {
                h: -90
            }), this.git6 = this.pie7 || C(this.primaryColor, {
                h: 60
            }), this.git7 = this.pie8 || C(this.primaryColor, {
                h: 120
            }), this.gitInv0 = this.gitInv0 || w(this.git0), this.gitInv1 = this.gitInv1 || w(this.git1), this.gitInv2 = this.gitInv2 || w(this.git2), this.gitInv3 = this.gitInv3 || w(this.git3), this.gitInv4 = this.gitInv4 || w(this.git4), this.gitInv5 = this.gitInv5 || w(this.git5), this.gitInv6 = this.gitInv6 || w(this.git6), this.gitInv7 = this.gitInv7 || w(this.git7), this.branchLabelColor = this.branchLabelColor || this.labelTextColor, this.gitBranchLabel0 = this.branchLabelColor, this.gitBranchLabel1 = `white`, this.gitBranchLabel2 = this.branchLabelColor, this.gitBranchLabel3 = `white`, this.gitBranchLabel4 = this.branchLabelColor, this.gitBranchLabel5 = this.branchLabelColor, this.gitBranchLabel6 = this.branchLabelColor, this.gitBranchLabel7 = this.branchLabelColor, this.tagLabelColor = this.tagLabelColor || this.primaryTextColor, this.tagLabelBackground = this.tagLabelBackground || this.primaryColor, this.tagLabelBorder = this.tagBorder || this.primaryBorderColor, this.tagLabelFontSize = this.tagLabelFontSize || `10px`, this.commitLabelColor = this.commitLabelColor || this.secondaryTextColor, this.commitLabelBackground = this.commitLabelBackground || this.secondaryColor, this.commitLabelFontSize = this.commitLabelFontSize || `10px`, this.emUiFill = this.emUiFill || `white`, this.emUiStroke = this.emUiStroke || `#dbdada`, this.emProcessorFill = this.emProcessorFill || `#edb3f6`, this.emProcessorStroke = this.emProcessorStroke || `#b88cbf`, this.emReadModelFill = this.emReadModelFill || `#d3f1a2`, this.emReadModelStroke = this.emReadModelStroke || `#a3b732`, this.emCommandFill = this.emCommandFill || `#bcd6fe`, this.emCommandStroke = this.emCommandStroke || `#679ac3`, this.emEventFill = this.emEventFill || `#ffb778`, this.emEventStroke = this.emEventStroke || `#c19a0f`, this.emSwimlaneBackgroundOdd = this.emSwimlaneBackgroundOdd || `rgb(250,250,250)`, this.emSwimlaneBackgroundStroke = this.emSwimlaneBackgroundStroke || `rgb(240,240,240)`, this.emArrowhead = this.emArrowhead || this.lineColor, this.emRelationStroke = this.emRelationStroke || this.lineColor, this.attributeBackgroundColorOdd = this.attributeBackgroundColorOdd || D, this.attributeBackgroundColorEven = this.attributeBackgroundColorEven || O;
        }
        calculate(e) {
            if (typeof e != `object`) {
                this.updateColors();
    ...
    me = class {
        ...
        updateColors() {
            this.primaryTextColor = this.primaryTextColor || (this.darkMode ? `#eee` : `#333`), this.secondaryColor = this.secondaryColor || C(this.primaryColor, {
                h: -120
            }), this.tertiaryColor = this.tertiaryColor || C(this.primaryColor, {
                h: 180,
                l: 5
            ...
            if (this.sectionBkgColor = this.sectionBkgColor || n, this.altSectionBkgColor = this.altSectionBkgColor || `white`, this.sectionBkgColor = this.sectionBkgColor || t, this.sectionBkgColor2 = this.sectionBkgColor2 || e, this.excludeBkgColor = this.excludeBkgColor || `#eeeeee`, this.taskBorderColor = this.taskBorderColor || this.primaryBorderColor, this.taskBkgColor = this.taskBkgColor || e, this.activeTaskBorderColor = this.activeTaskBorderColor || e, this.activeTaskBkgColor = this.activeTaskBkgColor || x(e, 23), this.gridColor = this.gridColor || `lightgrey`, this.doneTaskBkgColor = this.doneTaskBkgColor || `lightgrey`, this.doneTaskBorderColor = this.doneTaskBorderColor || `grey`, this.critBorderColor = this.critBorderColor || `#ff8888`, this.critBkgColor = this.critBkgColor || `red`, this.todayLineColor = this.todayLineColor || `red`, this.taskTextColor = this.taskTextColor || this.textColor, this.taskTextOutsideColor = this.taskTextOutsideColor || this.textColor, this.vertLineColor = this.vertLineColor || this.primaryBorderColor, this.taskTextLightColor = this.taskTextLightColor || this.textColor, this.taskTextColor = this.taskTextColor || this.primaryTextColor, this.taskTextDarkColor = this.taskTextDarkColor || this.textColor, this.taskTextClickableColor = this.taskTextClickableColor || `#003163`, this.archEdgeColor = this.lineColor, this.archEdgeArrowColor = this.lineColor, this.personBorder = this.personBorder || this.primaryBorderColor, this.personBkg = this.personBkg || this.mainBkg, this.transitionColor = this.transitionColor || this.lineColor, this.transitionLabelColor = this.transitionLabelColor || this.textColor, this.stateLabelColor = this.stateLabelColor || this.stateBkg || this.primaryTextColor, this.stateBkg = this.stateBkg || this.mainBkg, this.labelBackgroundColor = this.labelBackgroundColor || this.stateBkg, this.compositeBackground = this.compositeBackground || this.background || this.tertiaryColor, this.altBackground = this.altBackground || `#f0f0f0`, this.compositeTitleBackground = this.compositeTitleBackground || this.mainBkg, this.compositeBorder = this.compositeBorder || this.nodeBorder, this.innerEndBackground = this.nodeBorder, this.errorBkgColor = this.errorBkgColor || this.tertiaryColor, this.errorTextColor = this.errorTextColor || this.tertiaryTextColor, this.transitionColor = this.transitionColor || this.lineColor, this.specialStateColor = this.lineColor, this.cScale0 = this.cScale0 || e, this.cScale1 = this.cScale1 || t, this.cScale2 = this.cScale2 || n, this.cScale3 = this.cScale3 || C(e, {
                h: 30
            }), this.cScale4 = this.cScale4 || C(e, {
                h: 60
            }), this.cScale5 = this.cScale5 || C(e, {
                h: 90
            }), this.cScale6 = this.cScale6 || C(e, {
                h: 120
            }), this.cScale7 = this.cScale7 || C(e, {
                h: 150
            }), this.cScale8 = this.cScale8 || C(e, {
                h: 210,
                l: 150
            }), this.cScale9 = this.cScale9 || C(e, {
                h: 270
            }), this.cScale10 = this.cScale10 || C(e, {
                h: 300
            }), this.cScale11 = this.cScale11 || C(e, {
                h: 330
            }), this.darkMode) for(let e = 0; e < this.THEME_COLOR_LIMIT; e++)this[`cScale` + e] = S(this[`cScale` + e], 75);
            else for(let e = 0; e < this.THEME_COLOR_LIMIT; e++)this[`cScale` + e] = S(this[`cScale` + e], 25);
            for(let e = 0; e < this.THEME_COLOR_LIMIT; e++)this[`cScaleInv` + e] = this[`cScaleInv` + e] || w(this[`cScale` + e]);
            ...
            this.classText = this.classText || this.textColor, this.fillType0 = this.fillType0 || e, this.fillType1 = this.fillType1 || t, this.fillType2 = this.fillType2 || C(e, {
                h: 64
            }), this.fillType3 = this.fillType3 || C(t, {
                h: 64
            }), this.fillType4 = this.fillType4 || C(e, {
                h: -64
            }), this.fillType5 = this.fillType5 || C(t, {
                h: -64
            }), this.fillType6 = this.fillType6 || C(e, {
                h: 128
            }), this.fillType7 = this.fillType7 || C(t, {
                h: 128
            }), this.pie1 = this.pie1 || e, this.pie2 = this.pie2 || t, this.pie3 = this.pie3 || n, this.pie4 = this.pie4 || C(e, {
                l: -10
            }), this.pie5 = this.pie5 || C(t, {
                l: -10
            }), this.pie6 = this.pie6 || C(n, {
                l: -10
            }), this.pie7 = this.pie7 || C(e, {
                h: 60,
                l: -10
                ...
                h: -60
            }), this.git5 = this.git5 || C(e, {
                h: -90
            }), this.git6 = this.git6 || C(e, {
                h: 60
            }), this.git7 = this.git7 || C(e, {
                h: 120
    ...
    ge = class {
        ...
        constructor(){
            this.background = `#333`, this.primaryColor = `#1f2020`, this.secondaryColor = x(this.primaryColor, 16), this.tertiaryColor = C(this.primaryColor, {
                h: -160
            }), this.primaryBorderColor = w(this.background), this.secondaryBorderColor = k(this.secondaryColor, this.darkMode), this.tertiaryBorderColor = k(this.tertiaryColor, this.darkMode), this.primaryTextColor = w(this.primaryColor), this.secondaryTextColor = w(this.secondaryColor), this.tertiaryTextColor = w(this.tertiaryColor), this.mainBkg = `#2a2020`, this.secondBkg = `calculated`, this.mainContrastColor = `lightgrey`, this.darkTextColor = x(w(`#323D47`), 10), this.border1 = `#ccc`, this.border2 = v(255, 255, 255, .25), this.arrowheadColor = w(this.background), this.fontFamily = `arial, sans-serif`, this.fontSize = `14px`, this.labelBackground = `#181818`, this.textColor = `#ccc`, this.THEME_COLOR_LIMIT = 12, this.radius = 3, this.strokeWidth = 1, this.noteBkgColor = `#fff5ad`, this.noteTextColor = `#333`, this.THEME_COLOR_LIMIT = 12, this.fontFamily = `arial, sans-serif`, this.fontSize = `14px`, this.useGradient = !0, this.gradientStart = `#0042eb`, this.gradientStop = `#eb0042`, this.dropShadow = `drop-shadow( 1px 2px 2px rgba(185,185,185,0.2))`, this.archEdgeColor = `calculated`, this.archEdgeArrowColor = `calculated`, this.archEdgeWidth = `3`, this.archGroupBorderColor = this.primaryBorderColor, this.archGroupBorderWidth = `2px`, this.noteFontWeight = `normal`, this.fontWeight = `normal`;
        }
        updateColors() {
            if (this.primaryTextColor = this.primaryTextColor || (this.darkMode ? `#eee` : `#333`), this.secondaryColor = this.secondaryColor || C(this.primaryColor, {
                h: -120
            ...
            this.classText = this.classText || this.textColor, this.fillType0 = this.fillType0 || this.primaryColor, this.fillType1 = this.fillType1 || this.secondaryColor, this.fillType2 = this.fillType2 || C(this.primaryColor, {
                ...
                yAxisLineColor: this.xyChart?.yAxisLineColor || this.primaryTextColor,
                plotColorPalette: this.xyChart?.plotColorPalette || `#FFF4DD,#FFD8B1,#FFA07A,#ECEFF1,#D6DBDF,#C3E0A8,#FFB6A4,#FFD74D,#738FA7,#FFFFF0`
            }, this.requirementBackground = this.requirementBackground || this.primaryColor, this.requirementBorderColor = this.requirementBorderColor || this.primaryBorderColor, this.requirementBorderSize = this.requirementBorderSize || `1`, this.requirementTextColor = this.requirementTextColor || this.primaryTextColor, this.relationColor = this.relationColor || this.lineColor, this.relationLabelBackground = this.relationLabelBackground || (this.darkMode ? S(this.secondaryColor, 30) : this.secondaryColor), this.relationLabelColor = this.relationLabelColor || this.actorTextColor, this.git0 = this.git0 || `#0b0000`, this.git1 = this.git1 || `#4d1037`, this.git2 = this.git2 || `#3f5258`, this.git3 = this.git3 || `#4f2f1b`, this.git4 = this.git4 || `#6e0a0a`, this.git5 = this.git5 || `#3b0048`, this.git6 = this.git6 || `#995a01`, this.git7 = this.git7 || `#154706`, this.gitDarkMode = !0, this.gitDarkMode ? (this.git0 = x(this.git0, 25), this.git1 = x(this.git1, 25), this.git2 = x(this.git2, 25), this.git3 = x(this.git3, 25), this.git4 = x(this.git4, 25), this.git5 = x(this.git5, 25), this.git6 = x(this.git6, 25), this.git7 = x(this.git7, 25)) : (this.git0 = S(this.git0, 25), this.git1 = S(this.git1, 25), this.git2 = S(this.git2, 25), this.git3 = S(this.git3, 25), this.git4 = S(this.git4, 25), this.git5 = S(this.git5, 25), this.git6 = S(this.git6, 25), this.git7 = S(this.git7, 25)), this.gitInv0 = this.gitInv0 || w(this.git0), this.gitInv1 = this.gitInv1 || w(this.git1), this.gitInv2 = this.gitInv2 || w(this.git2), this.gitInv3 = this.gitInv3 || w(this.git3), this.gitInv4 = this.gitInv4 || w(this.git4), this.gitInv5 = this.gitInv5 || w(this.git5), this.gitInv6 = this.gitInv6 || w(this.git6), this.gitInv7 = this.gitInv7 || w(this.git7), this.branchLabelColor = this.branchLabelColor || (this.darkMode ? `black` : this.labelTextColor), this.gitBranchLabel0 = this.gitBranchLabel0 || this.branchLabelColor, this.gitBranchLabel1 = this.gitBranchLabel1 || this.branchLabelColor, this.gitBranchLabel2 = this.gitBranchLabel2 || this.branchLabelColor, this.gitBranchLabel3 = this.gitBranchLabel3 || this.branchLabelColor, this.gitBranchLabel4 = this.gitBranchLabel4 || this.branchLabelColor, this.gitBranchLabel5 = this.gitBranchLabel5 || this.branchLabelColor, this.gitBranchLabel6 = this.gitBranchLabel6 || this.branchLabelColor, this.gitBranchLabel7 = this.gitBranchLabel7 || this.branchLabelColor, this.tagLabelColor = this.tagLabelColor || this.primaryTextColor, this.tagLabelBackground = this.tagLabelBackground || this.primaryColor, this.tagLabelBorder = this.tagBorder || this.primaryBorderColor, this.tagLabelFontSize = this.tagLabelFontSize || `10px`, this.commitLabelColor = this.commitLabelColor || this.secondaryTextColor, this.commitLabelBackground = this.commitLabelBackground || this.secondaryColor, this.commitLabelFontSize = this.commitLabelFontSize || `10px`, this.attributeBackgroundColorOdd = this.attributeBackgroundColorOdd || D, this.attributeBackgroundColorEven = this.attributeBackgroundColorEven || O;
        }
        calculate(e) {
            if (typeof e != `object`) {
                this.updateColors();
    ...
    Se = class {
        ...
        updateColors() {
            this.primaryTextColor = this.primaryTextColor || (this.darkMode ? `#eee` : `#28253D`), this.secondaryColor = this.secondaryColor || C(this.primaryColor, {
                ...
                h: 180,
                l: 5
            }), this.primaryBorderColor = this.primaryBorderColor || k(this.primaryColor, this.darkMode), this.secondaryBorderColor = this.secondaryBorderColor || k(this.secondaryColor, this.darkMode), this.tertiaryBorderColor = this.tertiaryBorderColor || k(this.tertiaryColor, this.darkMode), this.noteBorderColor = this.noteBorderColor || k(this.noteBkgColor, this.darkMode), this.noteBkgColor = this.noteBkgColor || `#fff5ad`, this.noteTextColor = this.noteTextColor || `#28253D`, this.secondaryTextColor = this.secondaryTextColor || w(this.secondaryColor), this.tertiaryTextColor = this.tertiaryTextColor || w(this.tertiaryColor), this.lineColor = this.lineColor || w(this.background), this.arrowheadColor = this.arrowheadColor || w(this.background), this.textColor = this.textColor || this.primaryTextColor, this.border2 = this.border2 || this.tertiaryBorderColor, this.nodeBkg = this.nodeBkg || this.primaryColor, this.mainBkg = this.mainBkg || this.primaryColor, this.nodeBorder = this.nodeBorder || this.primaryBorderColor, this.clusterBkg = this.clusterBkg || this.tertiaryColor, this.clusterBorder = this.clusterBorder || this.tertiaryBorderColor, this.defaultLinkColor = this.defaultLinkColor || this.lineColor, this.titleColor = this.titleColor || this.tertiaryTextColor, this.edgeLabelBackground = this.edgeLabelBackground || (this.darkMode ? S(this.secondaryColor, 30) : this.secondaryColor), this.nodeTextColor = this.nodeTextColor || this.primaryTextColor, this.actorBorder = this.actorBorder || this.primaryBorderColor, this.actorBkg = this.actorBkg || this.mainBkg, this.actorTextColor = this.actorTextColor || this.primaryTextColor, this.actorLineColor = this.actorLineColor || this.actorBorder, this.labelBoxBkgColor = this.labelBoxBkgColor || this.actorBkg, this.signalColor = this.signalColor || this.textColor, this.signalTextColor = this.signalTextColor || this.textColor, this.labelBoxBorderColor = this.labelBoxBorderColor || this.actorBorder, this.labelTextColor = this.labelTextColor || this.actorTextColor, this.loopTextColor = this.loopTextColor || this.actorTextColor, this.activationBorderColor = this.activationBorderColor || S(this.secondaryColor, 10), this.activationBkgColor = this.activationBkgColor || this.secondaryColor, this.sequenceNumberColor = this.sequenceNumberColor || w(this.lineColor), this.rectBkgColor = this.rectBkgColor || this.tertiaryColor;
            let e = `#ECECFE`, t = `#E9E9F1`, n = C(e, {
                h: 180,
                l: 5
            });
    ...
    we = class {
        ...
        updateColors() {
            this.primaryTextColor = this.primaryTextColor || (this.darkMode ? `#eee` : `#FFFFFF`), this.secondaryColor = this.secondaryColor || C(this.primaryColor, {
                h: -120
            }), this.tertiaryColor = this.tertiaryColor || C(this.primaryColor, {
                h: 180,
                l: 5
    ...
    A = {
        ...
        neutral: {
            getThemeVariables: pe
        },
        neo: {
            getThemeVariables: he
        },
        "neo-dark": {
            getThemeVariables: _e
        },
        redux: {
            getThemeVariables: ye
        },
        "redux-dark": {
            getThemeVariables: xe
        },
        "redux-color": {
            getThemeVariables: Ce
        },
        "redux-dark-color": {
    ...
    Ee = r((e, t = ``)=>Object.keys(e).reduce((n, r)=>Array.isArray(e[r]) ? n : typeof e[r] == `object` && e[r] !== null ? [
                ...n,
                t + r,
                ...Ee(e[r], ``)
            ] : [
    ...
    Ae = r((e, t)=>{
        for (let n of Object.keys(e)){
            let r = e[n];
            (n.startsWith(`__`) || n.includes(`proto`) || n.includes(`constr`) || typeof r != `string` || !t.test(r)) && (o.debug(`sanitize deleting dictionary entry:`, n, r), delete e[n]);
        }
    }, `sanitizeDictionaryConfig`);
    M = r((e)=>{
        if (o.debug(`sanitizeDirective called with`, e), !(typeof e != `object` || !e)) {
            if (Array.isArray(e)) {
                e.forEach((e)=>M(e));
                return;
            }
            for (let t of Object.keys(e)){
                if (o.debug(`Checking key`, t), t.startsWith(`__`) || t.includes(`proto`) || t.includes(`constr`) || !De.has(t) || e[t] == null) {
                    o.debug(`sanitize deleting key: `, t), delete e[t];
                    continue;
                }
                if (typeof e[t] == `object`) {
                    let n = ke[t];
                    n ? Ae(e[t], n) : (o.debug(`sanitizing object`, t), M(e[t]));
                    continue;
                }
                for (let n of [
                    `themeCSS`,
                    `fontFamily`,
                    `altFontFamily`
                ])t.includes(n) && (o.debug(`sanitizing css option`, t), e[t] = je(e[t]));
            }
    ...
    Me = r((e)=>(F = E({}, N), F = E(F, e), e.theme && A[e.theme] && (F.themeVariables = A[e.theme].getThemeVariables(e.themeVariables)), z(F, L), F), `setSiteConfig`);
    Ne = r((e)=>{
        I = E({}, e);
    }, `saveConfigFromInitialize`);
    Pe = r((e)=>(F = E(F, e), z(F, L), F), `updateSiteConfig`);
    Fe = r(()=>E({}, F), `getSiteConfig`);
    Ie = r((e)=>(z(R, [
            e
        ]), B()), `setConfig`);
    B = r(()=>E({}, R), `getConfig`);
    Le = r((e)=>{
        e && ([
            ...
            Object.hasOwn(e, t) && (o.debug(`Denied attempt to modify a secure key ${t}`, e[t]), delete e[t]);
        }), Object.keys(e).forEach((t)=>{
            t.startsWith(`__`) && delete e[t];
        }), Object.keys(e).forEach((t)=>{
            typeof e[t] == `string` && (e[t].includes(`<`) || e[t].includes(`>`) || e[t].includes(`url(data:`)) && delete e[t], typeof e[t] == `object` && Le(e[t]);
        }));
    }, `sanitize`);
    Re = r((e)=>{
    ...
    Ve = {};
    He = r((e)=>{
        Ve[e] || (o.warn(Be[e]), Ve[e] = !0);
    }, `issueWarning`);
    Ue = r((e)=>{
        e && (e.lazyLoadedDiagrams || e.loadExternalDiagramsAtStartup) && He(`LAZY_LOAD_DEPRECATED`);
    }, `checkConfig`);
    We = r(()=>{
        let e = {};
        I && (e = E(e, I));
    ...
    Ge = r((e)=>(e.flowchart?.htmlLabels != null && He(`FLOWCHART_HTML_LABELS_DEPRECATED`), P(e.htmlLabels ?? e.flowchart?.htmlLabels ?? !0)), `getEffectiveHtmlLabels`);
    Ke = /^([^\S\n\r]*)-{3}\s*[\n\r](.*?)[\n\r]\1-{3}\s*[\n\r]+/s;
    qe = /%{2}{\s*(?:(\w+)\s*:|(\w+))\s*(?:(\w+)|((?:(?!}%{2}).|\r?\n)*))?\s*(?:}%{2})?/gi;
    Je = /\s*%%.*\n/gm;
    ...
    V = {};
    Xe = r(function(e, t) {
        e = e.replace(Ke, ``).replace(qe, ``).replace(Je, `
`);
        for (let [n, { detector: r }] of Object.entries(V))if (r(e, t)) return n;
        throw new Ye(`No diagram type detected matching given configuration for text: ${e}`);
    }, `detectType`);
    Ze = r((...e)=>{
        for (let { id: t, detector: n, loader: r } of e)Qe(t, n, r);
    }, `registerLazyLoadedDiagrams`);
    Qe = r((e, t, n)=>{
        V[e] && o.warn(`Detector with key ${e} already exists. Overwriting.`), V[e] = {
            detector: t,
            loader: n
        }, o.debug(`Detector with key ${e} added${n ? ` with loader` : ``}`);
    }, `addDetector`);
    $e = r((e)=>V[e].loader, `getDiagramLoader`);
    H = /<br\s*\/?>/gi;
    et = r((e)=>e ? lt(e).replace(/\\n/g, `#br#`).split(`#br#`) : [
            ``
        ], `getRows`);
    tt = (()=>{
        let e = !1;
    ...
    r(nt, `setupDompurifyHooks`);
    let rt, it, at, ot, st, ct, lt, dt, ft, W, mt, ht, gt, G, vt, xt, St, q;
    rt = r((e)=>(tt(), t.sanitize(e)), `removeScript`);
    it = r((e, t)=>{
        if (Ge(t)) {
            let n = t.securityLevel;
            n === `antiscript` || n === `strict` || n === `sandbox` ? e = rt(e) : n !== `loose` && (e = lt(e), e = e.replace(/</g, `&lt;`).replace(/>/g, `&gt;`), e = e.replace(/=/g, `&equals;`), e = ct(e));
        }
        return e;
    }, `sanitizeMore`);
    U = r((e, n)=>e && (e = n.dompurifyConfig ? t.sanitize(it(e, n), n.dompurifyConfig).toString() : t.sanitize(it(e, n), {
            FORBID_TAGS: [
                `style`
            ]
        }).toString(), e), `sanitizeText`);
    at = r((e, t)=>typeof e == `string` ? U(e, t) : e.flat().map((e)=>U(e, t)), `sanitizeTextOrArray`);
    ot = r((e)=>H.test(e), `hasBreaks`);
    st = r((e)=>e.split(H), `splitBreaks`);
    ct = r((e)=>e.replace(/#br#/g, `<br/>`), `placeholderToBreak`);
    lt = r((e)=>e.replace(H, `#br#`), `breakToPlaceholder`);
    ut = r((e)=>{
        let t = ``;
    ...
    pt = r(function(e) {
        ...
        for(let e = 0; e < t.length; e++){
            ...
            if (r === `,` && e > 0 && e + 1 < t.length) {
                let i = t[e - 1], a = t[e + 1];
                mt(i, a) && (r = i + `,` + a, e++, n.pop());
            }
            n.push(ht(r));
        }
        return n.join(``);
    }, `parseGenericTypes`);
    W = r((e, t)=>Math.max(0, e.split(t).length - 1), `countOccurrence`);
    mt = r((e, t)=>{
        let n = W(e, `~`), r = W(t, `~`);
        return n === 1 && r === 1;
    }, `shouldCombineSets`);
    ...
    gt = r(()=>window.MathMLElement !== void 0, `isMathMLSupported`);
    G = /\$\$(.*?)\$\$/g;
    K = r((e)=>(e.match(G)?.length ?? 0) > 0, `hasKatex`);
    _t = r(async (e, t)=>{
        let n = document.createElement(`div`);
        n.innerHTML = await yt(e, t), n.id = `katex-temp`, n.style.visibility = `hidden`, n.style.position = `absolute`, n.style.top = `0`, document.querySelector(`body`)?.insertAdjacentElement(`beforeend`, n);
        let r = {
            width: n.clientWidth,
    ...
    vt = r(async (e, t)=>{
        if (!K(e)) return e;
        if (!(gt() || t.legacyMathML || t.forceLegacyMathML)) return e.replace(G, `MathML is unsupported in this environment.`);
        {
            let { default: r } = await n(async ()=>{
            ...
            }, __vite__mapDeps([0,1,2])), i = t.forceLegacyMathML || !gt() && t.legacyMathML ? `htmlAndMathml` : `mathml`;
            return e.split(H).map((e)=>K(e) ? `<div style="display: flex; align-items: center; justify-content: center; white-space: nowrap;">${e}</div>` : `<div>${e}</div>`).join(``).replace(G, (e, t)=>r.renderToString(t, {
                    throwOnError: !0,
                    displayMode: !0,
                    output: i
                }).replace(/\n/g, ` `).replace(/<annotation.*<\/annotation>/g, ``));
        }
        return e.replace(G, `Katex is not supported in @mermaid-js/tiny. Please use the full mermaid library.`);
    }, `renderKatexUnsanitized`);
    yt = r(async (e, t)=>U(await vt(e, t), t), `renderKatexSanitized`);
    bt = {
        getRows: et,
        sanitizeText: U,
        sanitizeTextOrArray: at,
        hasBreaks: ot,
        splitBreaks: st,
        lineBreakRegex: H,
        removeScript: rt,
    ...
    Ct = r(function(e, t, n, r) {
        xt(e, St(t, n, r));
    }, `configureSvgSize`);
    wt = r(function(e, t, n, r) {
        let i = t.node().getBBox(), a = i.width, s = i.height;
        o.info(`SVG bounds: ${a}x${s}`, i);
        let c = 0, l = 0;
        o.info(`Graph bounds: ${c}x${l}`, e), c = a + n * 2, l = s + n * 2, o.info(`Calculated bounds: ${c}x${l}`), Ct(t, l, c, r);
...
`);
    ...
    r(Tt, `cssStyleSheetToString`);
    let Et, Dt;
    Et = r((e, t, n, r)=>{
        let i = ``;
        return e in q && q[e] ? i = q[e]({
            ...n,
            svgId: r
        }) : o.warn(`No theme found for ${e}`), `& {
...
`;
    ...
    let Y, X, Z, Q, It, Lt, Ut, $, Kt;
    Y = ``;
    X = ``;
    Z = ``;
    Q = r((e)=>U(e, B()), `sanitizeText`);
    kt = r(()=>{
        Y = ``, Z = ``, X = ``;
    }, `clear`);
    At = r((e)=>{
...
`);
    ...
    Nt = r(()=>Z, `getAccDescription`);
    Pt = r((e)=>{
        X = Q(e);
    }, `setDiagramTitle`);
    Ft = r(()=>X, `getDiagramTitle`);
    It = o;
    Lt = a;
    Rt = B;
    zt = Ie;
    Bt = N;
    Vt = r((e)=>U(e, Rt()), `sanitizeText`);
    Ht = wt;
    Ut = r(()=>J, `getCommonDb`);
    $ = {};
    Wt = r((e, t, n)=>{
        $[e] && It.warn(`Diagram with id ${e} already registered. Overwriting.`), $[e] = t, n && Qe(e, n), Dt(e, t.styles), t.injectUtils?.(It, Lt, Rt, Vt, Ht, Ut(), ()=>{});
    }, `registerDiagram`);
    Gt = r((e)=>{
        if (e in $) return $[e];
        throw new Kt(e);
...
export { S as $, K as A, Vt as B, $e as C, le as D, Fe as E, yt as F, zt as G, Mt as H, ze as I, wt as J, Pt as K, je as L, pt as M, Wt as N, ut as O, Ze as P, Pe as Q, M as R, Gt as S, Ge as T, At as U, Ne as V, Ie as W, Ot as X, Ht as Y, A as Z, Ke as _, kt as a, c as at, B as b, Ct as c, Bt as d, x as et, Oe as f, P as g, qe as h, _t as i, _ as it, H as j, We as k, Tt as l, V as m, Re as n, y as nt, J as o, Xe as p, Me as q, E as r, v as rt, bt as s, Ye as t, b as tt, N as u, Nt as v, Ft as w, Rt as x, jt as y, U as z, __tla };
