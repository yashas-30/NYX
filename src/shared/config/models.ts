...
const RAW_AVAILABLE_MODELS: ModelOption[] = [
  ...
  { id: 'gemini-3.1-pro', name: 'Gemini 3.1 Pro', provider: 'gemini', description: "Cutting-edge Pro model for advanced reasoning and coding.", specs: { contextWindow: '2M', trainingData: '2026', maxOutput: '64K', modality: 'Multimodal' } },

  // ═══════════════════════════════════════════════════════════════════════════════
  // GEMINI DIRECT - Gemini 2.5 Series
  // ═══════════════════════════════════════════════════════════════════════════════
  { id: 'gemini-2.5-flash', name: 'Gemini 2.5 Flash', provider: 'gemini', description: "Highly Stable Flash model.", specs: { contextWindow: '1M', trainingData: '2025', maxOutput: '32K', modality: 'Multimodal' } },
  ...
  { id: 'gemma-4-27b-it', name: 'Gemma 4 27B', provider: 'gemini', description: "Google's open weights model", specs: { contextWindow: '256K', trainingData: '2026', maxOutput: '8K', modality: 'Text' } },
