...
| **Statements of Work (SOW)**        | Sits beneath an MSA. Defines explicitly _what_ is delivered. Highly standardized.                               | Same as US.                                                                             | Same as US.                                                                                                                                                                |
...
1. Always inject a GDPR compliance clause if the client does _any_ business in Europe.
