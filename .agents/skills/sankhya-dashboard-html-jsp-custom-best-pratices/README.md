...
- _"Crie a estrutura inicial de um dashboard Sankhya com uma tabela básica e integração JSTL."_
- _"Quais são as melhores práticas do Sankhya para montar uma query SQL parametrizada no JSP?"_
- _"Analise este JSP do meu widget do Sankhya e sugira melhorias com base no sankhya-dashboard skill."_
- _"Como uso a função openLevel para criar um drill-down multi-nível em HTML5 no Sankhya?"_
- _"Gere o CSS padrão (.card, variáveis de cor) recomendado pela skill do Sankhya."_
