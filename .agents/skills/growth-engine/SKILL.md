...
High Intent (converter): - "skill alexa inteligente" - "assistente alexa com ia" - "como usar claude no alexa"
...
1 semana antes: - Pedir a hunters influentes para cacar o produto - Preparar assets: logo, tagline, screenshots, video demo 60s - Warm up: posts no X/LinkedIn sobre o problema que Auri resolve - Recrutar 50 early adopters para upvotar no lancamento
