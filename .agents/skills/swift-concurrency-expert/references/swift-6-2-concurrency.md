...
Swift 6.2 supports these conformances. A conformance that needs main actor state is called an _isolated_ conformance. This is safe because the compiler ensures a main actor conformance is only used on the main actor.
