...
_Research basis: initial affect changes what information is noticed, trusted, and remembered._
...
_Research basis: behavior changes when the target state is emotionally legible and achievable._
...
_Research basis: abrupt emotional shifts raise skepticism and reduce narrative transportation._

**Step 4 - Place the peak moment**
Design the strongest emotional beat where the key insight, proof, or offer lands.
_Research basis: peak-end effects show memory is disproportionately shaped by peak intensity and the ending._

**Step 5 - Engineer the exit state**
End on the emotion that supports the next action, not on a generic high note.
_Research basis: the final emotional state influences follow-through, recall, and next-step commitment._
