...
- **`path`**: The location to save the note.
  - For `create` behavior: The _folder_ to save the note in (e.g., `Clippings/` or `Recipes/`).
  - For `append-specific` behavior: The _full file path_ of the note to append to (e.g., `Databases/Recipes.md`).
