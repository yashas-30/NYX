...
When an import is recorded, DSP stores a short reason explaining _why_ that dependency exists. This lives in the `exports/` reverse index of the imported entity. A dependency graph without reasons tells you _what imports what_; reasons tell you **what is safe to change and who will break**.
