...
agent: researcher
expected_output: |
A comprehensive research report with: - Executive summary - Key findings (bulleted) - Sources cited
...
from crewai.flow.flow import Flow, listen, start, and*, or*, router

class ContentFlow(Flow): # State persists across steps
