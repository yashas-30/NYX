...
"""Let user know you're typing.""" # Requires Senders API setup
pass
...
"""Handle failed message delivery.""" # Notify team, retry logic, etc.
pass

def handle_opt_out(phone: str):
"""Handle user opting out of messages.""" # Mark user as opted out in database # IMPORTANT: Must respect this!
pass
...
@exponential*backoff_retry(max_retries=5)
