...
export class UserController extends BaseController {
  ...
  async getUser(req: Request, res: Response): Promise<void> {
    try {
      ...
      const user = await this.withTransaction('user.get', 'db.query', () =>
  ...
  async createUser(req: Request, res: Response): Promise<void> {
    try {
      ...
      // Track performance
      const user = await this.withTransaction('user.create', 'db.mutation', () =>
...
router.get('/', SSOMiddlewareClient.verifyLoginStatus, auditMiddleware, async (req, res) =>
...
router.delete('/:id', SSOMiddlewareClient.verifyLoginStatus, auditMiddleware, async (req, res) =>
...
export class PostService {
  async createPost(data: CreatePostDTO, userId: string): Promise<SubmissionResult> {
    // Permission check
    ...
    const command = new CompleteStepCommand(data.stepInstanceId, userId, data.responses);
