...
- **The accent marks the ridge the story is about, not the worst performer.** In the shipped example it marks the service whose _shape_ is unusual, not the slowest one.
