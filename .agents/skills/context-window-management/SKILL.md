...
return {
system: Math.floor(totalTokens _ 0.10), // 10%
criticalContext: Math.floor(totalTokens _ 0.15), // 15%
history: Math.floor(totalTokens _ 0.40), // 40%
query: Math.floor(totalTokens _ 0.10), // 10%
