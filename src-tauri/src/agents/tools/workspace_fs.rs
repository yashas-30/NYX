// ─────────────────────────────────────────────────────────────────────────────
// NYX — Sandboxed Workspace Filesystem Tools
// ─────────────────────────────────────────────────────────────────────────────
...
mod tests {
    ...
    #[tokio::test]
    async fn test_workspace_fs_operations() {
        let temp_dir = std::env::temp_dir().join("nyx_workspace_fs_test");
        let _ = std::fs::create_dir_all(&temp_dir);

        let sandbox = WorkspaceSandbox::new(&temp_dir);
        let tools = WorkspaceFsTools::new(sandbox);
