...
Based on Robert C. Martin, _Clean Architecture_ (2017). Use this when you need detailed criteria for dependency direction, layers, and boundaries.
...
Use this when discussing module/package boundaries beyond single layers. For full treatment see _Clean Architecture_ (Martin, 2017).
