...
> _"Onboard diagram-design to my site — `https://example.com`"_
...
> _"Onboard diagram-design from my `acme-design` skill"_
...
> _"Onboard diagram-design from my design system at `~/projects/brand/design-tokens/`"_
