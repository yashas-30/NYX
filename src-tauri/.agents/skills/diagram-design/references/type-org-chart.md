...
**Best for:** human teams, agent teams, support escalation maps, role ownership, routing maps, and any hierarchy where the reader needs to know _who owns what_ rather than just parent → child structure.
