...
- **Direct Resource Mutation:** This is an _auditor_, not a deployment tool. It does not execute `terraform apply` or `kubectl apply`.
- **Post-Mortem Analysis:** For analyzing _why_ a previous AI session failed, use `/analyze-project` instead.
