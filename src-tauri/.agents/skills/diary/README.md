...
When a developer types `:{Write a diary entry using the diary skill}` in _any_ project directory, the system strictly executes the following atomic operations:
